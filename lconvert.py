...
def main():
  ...
  parser.add_argument('-q',  dest = 'QM', choices = ["HF", "MP2", "wB97XD", "CCSD(T)"], default="HF")
  ...
  parser.add_argument('-j',  dest = 'jobType', choices = ["opt", "sp", "freq", "cbs", "sapt"], default="sp")
  ...
  def ToCOM(fi,fo):
    ...
    if (jt == "OPT"):
      ...
      extra = '\n'
    key = " ".join(["#P", qm+"/"+bf, jt, "MaxDist=%s"%dk, extra])
